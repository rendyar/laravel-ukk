            ...
            <aside class="sidebar">
                <a href="#" class="sidebar-logo">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src=" {{ asset('/dashboard/assets/img/global/logo.svg') }}" alt="">
                ...
                <a href="{{ url('kamar')}}" class="sidebar-item" onclick="toggleActive(this)">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ url('fasilitas-hotel')}}" class="sidebar-item" onclick="toggleActive(this)">
                ...
                <h5 class="sidebar-title">Accounts</h5>
        ...
        <div class="col-12 col-xl-9">
            <div class="nav">
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    <div class="d-flex justify-content-start align-items-center">
                        <button id="toggle-navbar" onclick="toggleNavbar()">
                            <img src="{{ asset('/dashboard/assets/img/global/burger.svg') }}" class="mb-2" alt="">
                        </button>
                        <h2 class="nav-title">Overview</h2>
                    </div>
                    <button class="btn-notif d-block d-md-none"><img src="{{ asset('/dashboard/assets/img/global/bell.svg') }}" alt=""></button>
                </div>

                <div class="d-flex justify-content-between align-items-center nav-input-container">
                    <div class="nav-input-group">
                        <input type="text" class="nav-input" placeholder="Search people, team, project">
                        <button class="btn-nav-input"><img src="{{ asset('/dashboard/assets/img/global/search.svg') }}" alt=""></button>
                    </div>

                    <button class="btn-notif d-none d-md-block"><img src="{{ asset('/dashboard/assets/img/global/bell.svg') }}" alt=""></button>
                </div>
            </div>
